...
```
```python
from trino_crud.configs.ops.dml.select import SelectQuery, Query
from trino_crud.configs.ops.dml.common import Where, OrderBy
...
# DELETE
```python
from trino_crud.configs.ops.dml.delete import Delete
...
# INSERT
```python
from trino_crud.configs.ops.dml.insert import InsertValues
...
# INSERT WITH QUERY
```python
from trino_crud.configs.ops.dml.insert import InsertSelect
...
# TRUNCATE
```python
from trino_crud.configs.ops.dml.truncate import Truncate

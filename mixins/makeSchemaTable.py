...
from trino_ops_utils.configs import Column, TableProp
...
class MakeSchemaTableMixin:
    ...
    - :class:`~trino_ops_utils.configs.TrinoSchema` for schema references (optionally with a location)
    - :class:`~trino_ops_utils.configs.TrinoTableDDL` for table DDL definitions
    - :class:`~trino_ops_utils.configs.TableProp` for table properties (format, partitioning, etc.)
    ...
    def make_schema(
        ...
        *,
        ...
        """
        Build a :class:`~trino_ops_utils.configs.TrinoSchema`.
    ...
    def make_table(
        ...
        *,
        ...
        """        
        Build a :class:`~trino_ops_utils.configs.TrinoTableDDL` definition.
        ...
        Args:
            ...
            format: Storage format (e.g. ``"ORC"``, ``"PARQUET"``), passed into
                :class:`~trino_ops_utils.configs.TableProp`.
